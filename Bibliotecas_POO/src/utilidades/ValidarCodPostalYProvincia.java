...
public class ValidarCodPostalYProvincia extends Direccion{
	...
	public static boolean validar(String codigoPostal, String provincia) {
        String codigoProvincia = codigoPostal.substring(0, 2);
        return provincias.containsKey(codigoProvincia) && provincias.get(codigoProvincia).equals(provincia);
	}
